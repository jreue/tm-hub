...
class DisplayController {
  public:
    DisplayController();
    void begin(int deviceCount, uint8_t targetMonth, uint8_t targetDay, uint16_t targetYear,
               uint8_t currentMonth, uint8_t currentDay, uint16_t currentYear, uint8_t lastMonth,
               uint8_t lastDay, uint16_t lastYear);
